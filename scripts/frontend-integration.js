 ...
 * This file demonstrates how to integrate Netharbor with a web frontend
 */

// For React/Vue/Angular applications
export class NetharborClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NetharborClient(provider, contractAddress);
